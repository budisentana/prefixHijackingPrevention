"""
    - Find random router from the node_setup.txt
...
router_number = len(open(file_path).readlines())
...
"""
os.chdir(root+'/scale')
conf_path = root+'/scale/dispatcher/config.json'
...
prefix_list = root+'/scale/prefix_list.txt'
